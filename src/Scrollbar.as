	...
	*/
	public class Scrollbar extends MovieClip
	{
		...
		public function upScroll(event:MouseEvent):void {
			...
			addEventListener(Event.ENTER_FRAME, upScrollControlHandler);
		}
		
		public function downScroll(event:MouseEvent):void {
			isDown = true;
			stage.addEventListener(MouseEvent.MOUSE_UP, stopScroll);
			addEventListener(Event.ENTER_FRAME, downScrollControlHandler);
		}
		...
		public function stopScroll(event:MouseEvent):void {
			...
			removeEventListener(Event.ENTER_FRAME, upScrollControlHandler);
			removeEventListener(Event.ENTER_FRAME, downScrollControlHandler);
		}
		//
